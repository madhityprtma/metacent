...
import 'package:tugas_akhir_flutter/checkout_cash.dart'; // Import halaman CheckoutDanaPage

class DanaPage extends StatelessWidget {
  final List<Point> points = [
    Point('Rp5.000', 5000, 'assets/images/dana1.png'),
    Point('Rp10.000', 10000, 'assets/images/dana1.png'),
    Point('Rp15.000', 15000, 'assets/images/dana1.png'),
    Point('Rp20.000', 20000, 'assets/images/dana1.png'),
    Point('Rp25.000', 25000, 'assets/images/dana1.png'),
  ];
