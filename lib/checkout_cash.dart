...
class CheckoutCashPage extends StatefulWidget {
  ...
  @override
  _CheckoutCashPageState createState() => _CheckoutCashPageState();
}

class _CheckoutCashPageState extends State<CheckoutCashPage> {
  late User _user;
  ...
  Future<void> _openWhatsApp(String name, String phone) async {
    ...
    final message =
        ...
        'Verification Data %0AName: $nameEncoded%0APhone Number: $phoneEncoded';
