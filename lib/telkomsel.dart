...
class TelkomselPage extends StatelessWidget {
  final List<Point> points = [
    Point('Rp5.000', 5000, 'assets/images/telkomsel.png'),
    Point('Rp10.000', 10000, 'assets/images/telkomsel.png'),
    Point('Rp15.000', 15000, 'assets/images/telkomsel.png'),
    Point('Rp20.000', 20000, 'assets/images/telkomsel.png'),
    Point('Rp25.000', 25000, 'assets/images/telkomsel.png'),
  ];
            ...
            child: ListTile(
              ...
              trailing: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  primary: Color.fromRGBO(198, 0, 15, 1),
                ),
                child: Text(
                  'Redeem',
                  style: TextStyle(
