...
class VoucherPage extends StatelessWidget {
  final List<Point> points = [
    Point('Voucher A', 10000, 'assets/images/voucher.png'),
    Point('Voucher B', 20000, 'assets/images/voucher.png'),
    Point('Voucher C', 30000, 'assets/images/voucher.png'),
    Point('Voucher D', 40000, 'assets/images/voucher.png'),
    Point('Voucher E', 50000, 'assets/images/voucher.png'),
  ];
